...
bem = 9165 * 4.448 #pound-force to Newtons
...
payloadmass = (mass_seat1+mass_seat2+mass_seat3+mass_seat4+mass_seat5+mass_seat6+mass_seat7+mass_seat8+mass_seat10+nosebaggagemass+aftcabinmass+aftcabinmass2)*0.453592
ramp_mass = (bem/9.81 + payloadmass + 4050*0.453592)
...
aftcabbaggage =0
aftcabbaggage2 =0
bemcg =291.55 * 0.0254        #PRIME SUSPECT IN CG PROBLEMS
payloadcg =0
wingcg = 315.5 * 0.0254
zfmcg =280.4 * 0.0254
